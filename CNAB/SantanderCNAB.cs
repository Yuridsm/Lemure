...
public class SantanderCNAB
{
	...
	public static async Task ExecuteUseCase()
	{
		...
		var files = new List<string>()
		{
			...
			$"CNAB/FORN_BTQ0_44_310823P_CRI.TXT",
			$"CNAB/FORN_BTQ0_59_310823P_MOV.TXT",
	...
	private static void ChangeState(IEnumerable<Boleto> boletos, string motivation)
	{
		foreach(var boleto in boletos)
		{
			boleto.OcorrenciaParaRetornoRemessa = motivation;
		}
	}
